...
import image from "../assets/image/WhatsApp Image 2024-07-29 at 7.58.10 PM.jpeg";
import image1 from "../assets/image/about.jfif";
export const About = () => {
  return (
    <>
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 lg:p-10 text-center space-y-6">
          <span className="text-white text-3xl lg:text-7xl font-bold gradient-text">
            Our Core Purpose
          </span>
      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Founded in 1995, DEVKI GROUP is a trailblazer in the Indian
              construction industry, renowned for delivering world-class
              engineering and construction services. We have consistently
              achieved milestones with our innovative approach, shaping landmark
              projects that contribute to the nation’s progress. Our presence
              spans multiple sectors, driven by a commitment to safety and
              excellence in every infrastructure project we undertake. At DEVKI
              GROUP, we are dedicated to empowering lives and fostering growth,
              believing that our success fuels the advancement of both our
              people and our company. Each accomplishment serves as a stepping
              stone for greater achievements, reinforcing our role as industry
              leaders who embrace bold challenges and envision a brighter
              future.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <img
              className="  w-full rounded-2xl cursor-pointer transition-all duration-300 ease-in-out hover:scale-110"
              src={image}
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Established in 1995, DEVKI GROUP pioneers the Indian
              infrastructure industry with world-class engineering and
          ...
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              DEVKI GROUP has successfully delivered over 50 projects, cementing
              its reputation as a leader in the Indian infrastructure sector
              with its exceptional engineering and construction capabilities.{" "}
            </p>
          </div>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              Our mission is to establish ourselves as the leading authority in
              the engineering and construction industry by consistently setting
              the highest standards of market-driven solutions. We are committed
              to delivering innovative and exceptional construction services
              that exceed client expectations and drive industry advancements.
              Our focus is on fostering long-term relationships with
              stakeholders by prioritizing integrity, excellence, and customer
              satisfaction in every project we undertake.
            </p>

            <h2 className="font-bold mt-5 lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800">
              Our Vision
            </h2>
            <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-5">
              Our vision is to be universally recognized as the benchmark for
              excellence, quality, and performance within the construction
              sector. We aspire to achieve this by consistently delivering
              superior construction solutions that reflect our unwavering
              commitment to reliability and innovation. Through our dedication
              to operational excellence and our relentless pursuit of
              industry-leading practices, we aim to redefine the standards of
              construction, setting new benchmarks for success and inspiring
              confidence in every endeavor.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              {/* <!-- Team Card --> */}
              <div className="flex p-4 shadow-lg  shadow-gray-600">
                <div className="mr-6">
                  <svg
                    width="36"
                    height="36"
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    Our core team, comprising over 1,458 highly skilled
                    professionals, is the cornerstone of our success. With a
                    wealth of experience and a commitment to excellence, they
                    drive our mission forward, ensuring top-tier engineering and
                    construction services and consistently exceeding client
                    expectations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex p-4 shadow-lg shadow-gray-600">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    Our strengths are demonstrated by our use of
                    state-of-the-art machinery and a proven track record of
                    delivering over 5,000,000 square feet in completed projects.
                    With a presence in three cities and an annual turnover of
                    ₹40 to ₹50 crore, we maintain a strong national footprint
                    and robust financial stability, solidifying our position as
                    an industry leader.
                  </p>
                </div>
              </div>
