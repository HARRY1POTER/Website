...
import image from "../assets/shutterstock_226935043.webp";
  ...
  return (
    <div>
      <div className="relative">
        ...
        />
        <p className="absolute inset-0 lg:text-7xl flex items-center justify-center text-white font-bold top-72 text-5xl">
          Contact Us
        </p>
      </div>
