      ...
      <section className="border-t border-gray-700 py-4">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a href="/" className="text-gray-400 hover:text-red-500" aria-label="Google">
              <FcGoogle size={22} />
            </a>
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col lg:flex-row lg:space-x-8 ">
      ...
      <div className="flex-1 mb-8 lg:mb-0">
        ...
        Our company has always worked on improving and initiating growth by producing quality products locally that enhance our customers need. As Devki Group, we continue to give the best of all to our customers, staff, employees for their and  a better tomorrow.  </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="/capabilities" className="hover:underline">Services & Resources</a>
                </li>
                <li className="mb-4">
       ...
       {/*  <div>
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Get in TouchS</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <a href="#" className="hover:underline">0123456789 | 1236547890</a>
                </li>
                {/* <li className="mb-4">
...
sales@devkisteel.com
</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">info@devkisteel.com</a>
                </li>
            </ul>
        </div>
    </div>
